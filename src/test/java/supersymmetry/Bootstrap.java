...
public class Bootstrap {
    ...
    public static void perform() {
        ...
        ModMetadata gt = new ModMetadata();
        gt.modId = GTValues.MODID;
        ModMetadata susy = new ModMetadata();
        susy.modId = Supersymmetry.MODID;
        Loader.instance().setupTestHarness(new DummyModContainer(gt), new DummyModContainer(susy));
