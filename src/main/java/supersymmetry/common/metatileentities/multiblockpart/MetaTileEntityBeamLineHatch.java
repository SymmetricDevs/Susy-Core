...
public class MetaTileEntityBeamLineHatch extends MetaTileEntityMultiblockPart implements IParticleBeamProvider, IMultiblockAbilityPart<IParticleBeamProvider> {
