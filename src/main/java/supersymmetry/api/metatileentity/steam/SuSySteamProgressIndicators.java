...
public class SuSySteamProgressIndicators {
    ...
    public static final SuSySteamProgressIndicator EXTRACTION_STEAM = new SuSySteamProgressIndicator(SusyGuiTextures.PROGRESS_BAR_EXTRACTION_STEAM, ProgressWidget.MoveType.VERTICAL_DOWNWARDS, 20, 20);
