...
public class SlotWidgetMentallyStable extends Widget implements INativeWidget {
  ...
  public void drawInForeground(int mouseX, int mouseY) {
    ...
    if (tooltipText != null && isMouseOverElement(mouseX, mouseY) && !slotReference.getHasStack()) {
      List<String> hoverList =
          Arrays.asList(LocalizationUtils.formatLines(tooltipText, tooltipArgs));
  ...
  public void drawInBackground(int mouseX, int mouseY, float partialTicks, IRenderContext context) {
    ...
    if (itemStack.isEmpty()
      ...
      if (!itemStack.isEmpty()
          && splitSize > 1
          && Container.canAddItemToSlot(slotReference, itemStack, true)) {
    ...
    if (isActive()) {
      if (slotReference instanceof ISlotWidgetMentallyStable) {
  ...
  public SlotWidgetMentallyStable setConsumer(Consumer<SlotWidgetMentallyStable> consumer) {
    this.consumer = consumer;
    return this;
  }

  public SlotWidgetMentallyStable setChangeListener(Runnable changeListener) {
  ...
  public SlotWidgetMentallyStable setLocationInfo(boolean isPlayerInventory, boolean isHotbarSlot) {
    this.locationInfo = new SlotLocationInfo(isPlayerInventory, isHotbarSlot);
    return this;
  }

  public SlotWidgetMentallyStable setTooltipText(String tooltipText, Object... args) {
  ...
  public interface ISlotWidgetMentallyStable {
  ...
  protected class WidgetSlot extends Slot implements ISlotWidgetMentallyStable {
    ...
    public boolean isItemValid(@NotNull ItemStack stack) {
      return SlotWidgetMentallyStable.this.canPutStack(stack) && super.isItemValid(stack);
    }
    ...
    @Override
    public void onSlotChanged() {
      SlotWidgetMentallyStable.this.onSlotChanged();
    }

    @Override
    public boolean isEnabled() {
      return SlotWidgetMentallyStable.this.isEnabled();
    }
  }

  public class WidgetSlotItemHandler extends SlotItemHandler implements ISlotWidgetMentallyStable {
