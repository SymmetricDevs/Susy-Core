        ...
        if ((!(entity instanceof EntityPlayer) && !(entity instanceof EntityFlying)) || (!(entity instanceof EntityFlying) && !(((EntityPlayer) entity).capabilities.isFlying || ((EntityLivingBase) entity).isElytraFlying()))) {
            ...
            if (entityMap.containsKey(entity) && (d = entityMap.get(entity)) != null) {
                ...
                if (entity instanceof EntityItem)
                    ...
                    // Normally gravity works for living entities by accelerating motionY by 0.08, and then applying "drag"
                    // in the form of multiplying the resulting value by 0.98.
                    // This code we have here runs *before* all of that, and I'm not about to make a second mixin to change that.
