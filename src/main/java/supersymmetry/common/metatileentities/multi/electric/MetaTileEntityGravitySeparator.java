    ...
    protected @NotNull BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start(RIGHT, UP, FRONT)
                ...
                */
                ...
                .where('I', states(new IBlockState[] {MetaBlocks.METAL_CASING.getState(BlockMetalCasing.MetalCasingType.STEEL_SOLID)})
                        .or(autoAbilities(false, false, true, false, false, false, false)))
                .where('O', states(new IBlockState[] {MetaBlocks.METAL_CASING.getState(BlockMetalCasing.MetalCasingType.STEEL_SOLID)})
                        .or(autoAbilities(false, false, false, true, false, false, false)))
                .where('J', states(new IBlockState[] {MetaBlocks.METAL_CASING.getState(BlockMetalCasing.MetalCasingType.STEEL_SOLID)})
                        .or(autoAbilities(false, false, false, false, true, false, false)))
                .where('F', states(new IBlockState[] {MetaBlocks.METAL_CASING.getState(BlockMetalCasing.MetalCasingType.STEEL_SOLID)})
