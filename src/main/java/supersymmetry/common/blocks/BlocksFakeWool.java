...
public class BlocksFakeWool extends VariantBlock<BlocksFakeWool.FakeWoolBlockType> {
    ...
    // probably a better way to do this, but not gonna lie not going to expend
    // energy on that since this works well
    // enough
    ...
    public static enum FakeWoolBlockType implements IStringSerializable, IStateHarvestLevel {
        ...
        MAGENTAFAKEWOOL("magentafakewool",
                0),
        ...
        GRAYFAKEWOOL("grayfakewool",
                0),
        LIGHTGRAYFAKEWOOL("lightgrayfakewool", 0),
        CYANFAKEWOOL("cyanfakewool",
                0),
        PURPLEFAKEWOOL("purplefakewool", 0),
        BLUEFAKEWOOL("bluefakewool",
                0),
        BROWNFAKEWOOL("brownfakewool", 0),
        GREENFAKEWOOL("greenfakewool",
                0),
        REDFAKEWOOL("redfakewool",
                0),
