...
public class MetaTileEntityLargeMixer extends RecipeMapMultiblockController {
    ...
    public MetaTileEntityLargeMixer(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, SuSyRecipeMaps.LARGE_MIXER_RECIPES);
    ...
    //Temporarily use LCR structure, subject to change
    @Override
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        MultiblockShapeInfo.Builder baseBuilder = MultiblockShapeInfo.builder()
                .where('S', MetaTileEntities.LARGE_MIXER_REACTOR, EnumFacing.SOUTH)
