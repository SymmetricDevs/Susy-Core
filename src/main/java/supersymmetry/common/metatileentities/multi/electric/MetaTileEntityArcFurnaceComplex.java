...
public class MetaTileEntityArcFurnaceComplex extends MetaTileEntityAdvancedArcFurnace {
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .aisle("AAAAAAA AAAAAAA", "AAAAAAA AAAAAAA", "AABBBAA AABBBAA", "A#####A A#####A", "E#####E E#####E", "E#####E E#####E", " AAAAA   AAAAA ", "               ", "               ", "               ")
                .aisle("AAAAAAA AAAAAAA", "AABBBAA AABBBAA", "AB###BA AB###BA", "A#####A A#####A", "ECC#CCE ECC#CCE", "ECC#CCE ECC#CCE", "ACCACCA ACCACCA", " CC CC   CC CC ", " CC CC   CC CC ", " CCACC   CCACC ")
                .aisle("AAAAAAA AAAAAAA", "AABBBAA AABBBAA", "AB###BA AB###BA", "A#####A A#####A", "E#####E E#####E", "E#####E E#####E", "AAAAAAA AAAAAAA", "               ", "               ", "  AAA     AAA  ")
                .aisle("AAAAAAA AAAAAAA", "AABBBAA AABBBAA", "AB###BA AB###BA", "A#####A A#####A", "E##C##E E##C##E", "E##C##E E##C##E", "AAACAAA AAACAAA", "   C       C   ", "   C       C   ", "  ACA     ACA  ")
                .aisle("AAAAAAA AAAAAAA", "AAAAAAA AAAAAAA", "AABBBAA AABBBAA", "A#####A A#####A", "E##C##E E##C##E", "E##C##E E##C##E", " AACAA   AACAA ", "   C       C   ", "   C       C   ", "  ACA     ACA  ")
