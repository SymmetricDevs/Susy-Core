...
public class SuSyRecipeMaps {
    ...
    public static final RecipeMap<MixerSettlerRecipeBuilder> MIXER_SETTLER_RECIPES = new RecipeMap<>("mixer_settler", 1, 1, 3, 2, new MixerSettlerRecipeBuilder().EUt(VA[LV]), false)
