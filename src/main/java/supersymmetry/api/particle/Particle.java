...
public class Particle {
     ...
     * @param spin     Spin of the particle in units of hbar, for more information on what spin is please complete a
     *                 undergrad quantum mechanics course
     * @param width    Mass width of the particle, this controls the mean lifetime, stable particles have a width of
     *                 zero
