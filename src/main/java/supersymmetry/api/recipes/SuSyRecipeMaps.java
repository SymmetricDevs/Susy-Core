...
public class SuSyRecipeMaps {
    ...
    public static final RecipeMap<SimpleRecipeBuilder> NATURAL_DRAFT_COOLING_TOWER = new RecipeMap<>("natural_draft_cooling_tower", 0, 0, 1, 1, new SimpleRecipeBuilder(), false)
