...
public class SuSyCoalBoiler extends SteamCoalBoiler {
    ...
    public static int modifyBurnTime(int burnTime, boolean highPressure) {
        ...
        // In there, burn progress will only increment every 12 ticks. It increments by
        // 2
        // for high pressure, and 1 for low pressure.
        // So we have to divide the burn time by 12 (low) or 6 (high) to make it match
        // the
        ...
        // So for a high pressure boiler, since it decrements by 2, an odd number means
        // it
        // *never warms up*. We will throw players a bone and give them 1 more tick if
        // it's odd.
        // It also never stops working if it's odd because it does a == 0 check and not
        // a <= 0.
