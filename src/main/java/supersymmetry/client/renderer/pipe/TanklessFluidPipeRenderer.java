...
public class TanklessFluidPipeRenderer extends PipeRenderer implements IconTypeExtension {
    ...
    public void buildRenderer(PipeRenderContext pipeRenderContext, BlockPipe<?, ?, ?> blockPipe,
        ...
        if (pipeType.isRestrictive()) {
            pipeRenderContext.addOpenFaceRender(false, new IconTransformation(Textures.RESTRICTIVE_OVERLAY));
        }
    }
    ...
    private static Cuboid6 getFlangeBox(@Nullable EnumFacing side, float thickness, boolean hasCover) {
