...
public class SuSyMetaArmor extends SuSyArmorItem {
    ...
    public void registerSubItems() {
        ...
        ASBESTOS_CHESTPLATE = addItem(5, "asbestos_chestplate").setArmorLogic(new AdvancedBreathingTank(1, "asbestos", 0, 0.3, 1200));
        ...
        REBREATHER_TANK = addItem(8, "rebreather_tank").setArmorLogic(new AdvancedBreathingTank(1, "rebreather", 0, 0.3, 3600));
        REFLECTIVE_MASK = addItem(9, "reflective_mask").setArmorLogic(new AdvancedBreathingApparatus(HEAD, 5, "reflective", 0, 0.4));
        REFLECTIVE_CHESTPLATE = addItem(10, "reflective_chestplate").setArmorLogic(new AdvancedBreathingTank(5, "reflective", 0, 0.4, 1200));
        ...
        FILTERED_TANK = addItem(13, "filtered_tank").setArmorLogic(new AdvancedBreathingTank(5, "filtered", 0, 0.4, AdvancedBreathingTank.INFINITE_OXYGEN));
        ...
        SPACE_HELMET = addItem(18, "space_helmet").setArmorLogic(new AdvancedBreathingApparatus(HEAD, 0, "spacesuit", 1, 0.6));
        SPACE_CHESTPLATE = addItem(19, "space_chestplate").setArmorLogic(new AdvancedBreathingTank(0, "spacesuit", 1, 0.6, 25200));
        SPACE_LEGGINGS = addItem(20, "space_leggings").setArmorLogic(new AdvancedBreathingApparatus(LEGS, 0, "spacesuit", 1, 0.6));
        SPACE_BOOTS = addItem(21, "space_boots").setArmorLogic(new AdvancedBreathingApparatus(FEET, 0, "spacesuit", 1, 0.6));
    }
}
