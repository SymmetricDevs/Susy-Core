...
public class ParticleBeam {
     ...
     * @param energy
     *                           The mean energy of the beam in MeV
     * @param bunchSpacing
     *                           Distance in nanoseconds between particle bunches
     * @param bunchLength
     *                           The length of a particle bunch in the lab frame
     * @param nBunches
     *                           Number of bunches in the beam
     * @param nParticlesPerBunch
     *                           Number of particles in each bunch
     * @param emittance
     *                           Emittance of the beam
     * @param beamSize
     *                           Transversal cross-section of the beam in micrometers
     */
