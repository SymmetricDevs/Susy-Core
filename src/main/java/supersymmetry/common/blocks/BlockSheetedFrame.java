...
public class BlockSheetedFrame extends Block {
    ...
    public static final PropertyEnum<FrameEnumAxis> SHEETED_FRAME_AXIS = PropertyEnum.<FrameEnumAxis>create("axis",
            FrameEnumAxis.class);
    ...
    public IBlockState getBlock(Material material) {
        return getDefaultState().withProperty(this.variantProperty, material).withProperty(SHEETED_FRAME_AXIS,
                FrameEnumAxis.Y);
    }
