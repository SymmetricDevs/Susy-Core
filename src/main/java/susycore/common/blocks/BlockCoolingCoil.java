...
public class BlockCoolingCoil extends VariantActiveBlock<BlockCoolingCoil.CoolingCoilType> {
    ...
    public enum CoolingCoilType implements IStringSerializable, IHeatingCoilBlockStats {
        ...
        PRASEODYMIUMNICKEL("praseodymium_nickel", 50, 1, 1, SusyMaterials.PraseodymiumNickel),
        GADOLINIUMSILICONGERMANIUM("gadolinium_silicon_germanium", 3, 1, 1, SusyMaterials.GadoliniumSiliconGermanium);
