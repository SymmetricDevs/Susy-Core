...
public class MetaTileEntitySolarFurnace extends RecipeMapMultiblockController {
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .aisle("               ", "               ", "       F       ", "       F       ", "               ", "               ", "               ", "               ", "               ", "               ", "               ")
                .aisle("FF           FF", "F             F", "               ", "       F       ", "       F       ", "               ", "               ", "               ", "               ", "               ", "               ")
                .aisle("F             F", "       F       ", " F     F     F ", " F   FFFFF   F ", "       F       ", "       F       ", "               ", "               ", "               ", "               ", "               ")
                .aisle("     FFFFF     ", "      MMM      ", "     MMMMM     ", "  FFFMMMMMFFF  ", "  F  MMMMM  F  ", "  F   MMM   F  ", "       F       ", "       F       ", "               ", "               ", "               ")
                .aisle("    FMMMMMF    ", "    MM###MM    ", "   MM#####MM   ", " FFMM#####MMFF ", "   MM#####MM   ", "    MM###MM    ", "   FMMMMMMMF   ", "   F  MMM  F   ", "       F       ", "       F       ", "               ")
                .aisle("  FFM#####MFF  ", "  MM#######MM  ", " MM#########MM ", "FMM#########MMF", " MM#########MM ", "  MM#######MM  ", "   M#######M   ", "   MMM###MMM   ", "    F MMM F    ", "    F  M  F    ", "      FFF      ")
                .aisle(" FMM#######MMF ", " M###########M ", "M#############M", "M#############M", "M#############M", " M###########M ", " MM#########MM ", "  M#########M  ", "  MMMM###MMMM  ", "    MMM#MMM    ", "     FMMMF     ")
                .aisle(" M###########M ", "M#############M", "###############", "###############", "###############", "M#############M", "M#############M", " M###########M ", " M###########M ", "  MM#######MM  ", "    MM###MM    ")
                .aisle("M#############M", "###############", "###############", "###############", "###############", "###############", "###############", " ############# ", " ############# ", "  ###########  ", "    #######    ")
                .aisle("#######I#######", "###############", "###############", "###############", "###############", "###############", "###############", " ############# ", " ############# ", "  ###########  ", "    #######    ")
                .aisle("####### #######", "#######I#######", "###############", "###############", "###############", "###############", "###############", " ############# ", " ############# ", "  ###########  ", "    #######    ")
                .aisle("#####I   I#####", "######I I######", "#######I#######", "#######C#######", "###############", "###############", "###############", " ############# ", " ############# ", "  ###########  ", "    #######    ")
