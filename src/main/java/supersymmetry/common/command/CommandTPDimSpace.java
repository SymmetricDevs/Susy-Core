 ...
 * /tpdim <dimId> [x] [y] [z]
 *
 * Teleports the executing player to the given dimension. Coordinates default to
 * (0, 128, 0) if not specified.
 *
...
public class CommandTPDimSpace extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        FMLCommonHandler.instance().getMinecraftServerInstance().getPlayerList().transferPlayerToDimension(player,
                dimId, new net.minecraft.world.Teleporter(server.getWorld(dimId)) {
