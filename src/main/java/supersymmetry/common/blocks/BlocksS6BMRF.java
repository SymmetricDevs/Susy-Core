...
public class BlocksS6BMRF extends VariantHorizontalRotatableBlock<BlocksS6BMRF.S6BMRFBlockType> {
    ...
    @Override
    public ItemStack getItemVariant(S6BMRFBlockType variant, int amount) {
