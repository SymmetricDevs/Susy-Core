...
public class SusyOrePrefix {
    ...
    // Electrode
    public static final OrePrefix electrode = new OrePrefix("electrode", GTValues.M, null, SuSyMaterialIconType.electrode, OrePrefix.Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(SuSyMaterialFlags.GENERATE_ELECTRODE));
}
