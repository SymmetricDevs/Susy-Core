...
public class BlockSeparatorRotor extends VariantBlock<BlockSeparatorRotor.BlockSeparatorRotorType> implements ISuSyHorizontalOrientable {
    ...
    public static enum BlockSeparatorRotorType implements IStringSerializable, IStateHarvestLevel {
        STEEL("steel", 2);

        private final String name;
        private final int harvestLevel;

        private BlockSeparatorRotorType(String name, int harvestLevel) {
            this.name = name;
