package supersymmetry.common.metatileentities.single.active;
...
public class MetaTileEntityFluidActiveCasing extends MetaTileEntity implements IControllable {
    ...
    private String getDisplaySizeText() {
        if (fluidDisplaySize == 0) return net.minecraft.util.text.translation.I18n
                .translateToLocal("susy.machine.active_fluid_effect_maker.display_size.thin");
        return fluidDisplaySize + " " + net.minecraft.util.text.translation.I18n
                .translateToLocal("susy.machine.active_fluid_effect_maker.display_size.blocks");
    }
