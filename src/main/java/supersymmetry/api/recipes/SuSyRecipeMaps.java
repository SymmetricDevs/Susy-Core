...
public class SuSyRecipeMaps {
    ...
    public static final RecipeMap<CoilingCoilRecipeBuilder> COOLING_RECIPES = new RecipeMap<>("magnetic_refrigerator",
            3, 3, 0, 1, new CoilingCoilRecipeBuilder(), false).setSound(GTSoundEvents.COOLING);

    public static final RecipeMap<SinteringRecipeBuilder> SINTERING_RECIPES = new RecipeMap<>("sintering_oven", 4, 4, 2,
            2, new SinteringRecipeBuilder(), false).setSound(GTSoundEvents.COMBUSTION);
    ...
    public static final RecipeMap<CatalystRecipeBuilder> VULCANIZATION_RECIPES = new RecipeMap<>("vulcanizing_press", 4,
            2, 2, 1, new CatalystRecipeBuilder(), false).setSlotOverlay(false, false, true, GuiTextures.MOLD_OVERLAY)
            .setSound(GTSoundEvents.COMBUSTION);

    public static final RecipeMap<CatalystRecipeBuilder> ROASTER_RECIPES = new RecipeMap<>("roaster", 3, 2, 2, 3,
            new CatalystRecipeBuilder(), false).setSound(GTSoundEvents.COMBUSTION);
    ...
    public static final RecipeMap<CatalystRecipeBuilder> CSTR_RECIPES = new RecipeMap<>(
            ...
            .setSlotOverlay(true, true, GuiTextures.VIAL_OVERLAY_2).setSound(GTSoundEvents.CHEMICAL_REACTOR);
    ...
    public static final RecipeMap<SimpleRecipeBuilder> CRYSTALLIZER_RECIPES = new RecipeMap<>("crystallizer", 4, 3, 3,
            3, new SimpleRecipeBuilder(), false).setSound(GTSoundEvents.CHEMICAL_REACTOR);

    public static final RecipeMap<SimpleRecipeBuilder> DRYER_RECIPES = new RecipeMap<>("dryer", 2, 2, 2, 2,
            new SimpleRecipeBuilder(), false).setSound(GTSoundEvents.COOLING);
    ...
    public static final RecipeMap<SimpleRecipeBuilder> ION_EXCHANGE_COLUMN_RECIPES = new RecipeMap<>(
            ...
            .setSlotOverlay(true, true, true, GuiTextures.MOLECULAR_OVERLAY_4).setSound(GTSoundEvents.BATH);
    ...
    public static final RecipeMap<SimpleRecipeBuilder> ZONE_REFINER_RECIPES = new RecipeMap<>("zone_refiner", 4, 1, 2,
            ...
            .setSlotOverlay(true, false, true, GuiTextures.CRYSTAL_OVERLAY).setSound(GTSoundEvents.FURNACE);
    ...
    public static final RecipeMap<CatalystRecipeBuilder> POLYMERIZATION_RECIPES = new RecipeMap<>("polymerization_tank",
            4, 1, 4, 2, new CatalystRecipeBuilder(), false).setSlotOverlay(false, true, GuiTextures.MOLECULAR_OVERLAY_3)
            .setSlotOverlay(true, true, GuiTextures.MOLECULAR_OVERLAY_3)
    ...
    public static final RecipeMap<SimpleRecipeBuilder> ELECTROLYTIC_CELL_RECIPES = new RecipeMap<>("electrolytic_cell",
            4, 3, 3, 4, new SimpleRecipeBuilder(), false).setSlotOverlay(false, true, GuiTextures.MOLECULAR_OVERLAY_3)
            .setSlotOverlay(true, true, GuiTextures.MOLECULAR_OVERLAY_3)
            .setSlotOverlay(false, false, SusyGuiTextures.ELECTRODE_OVERLAY)
            .setSlotOverlay(true, false, GuiTextures.MOLECULAR_OVERLAY_1).setSound(GTSoundEvents.ELECTROLYZER);

    public static final RecipeMap<SusyRecipeBuilder> COKING_RECIPES = new RecipeMap<>("coking_tower", 1, 1, 3, 2,
            new SusyRecipeBuilder(), false).setSound(GTSoundEvents.COMBUSTION);
    ...
    public static final RecipeMap<SimpleRecipeBuilder> FERMENTATION_VAT_RECIPES = new RecipeMap<>("vat_fermentation", 3,
            3, 3, 3, new SimpleRecipeBuilder(), false).setSlotOverlay(false, false, true, GuiTextures.DUST_OVERLAY)
            .setSlotOverlay(true, false, true, GuiTextures.DUST_OVERLAY)
            .setSound(GTSoundEvents.CHEMICAL_REACTOR);
    ...
    public static final RecipeMap<SimpleRecipeBuilder> SPUTTER_DEPOSITION_RECIPES = new RecipeMap<>(
            "sputter_deposition", 6, 1, 2, 2, new SimpleRecipeBuilder(), false).setSound(GTSoundEvents.ELECTROLYZER);

    public static final RecipeMap<SimpleRecipeBuilder> EVAPORATION_DEPOSITION_RECIPES = new RecipeMap<>(
            "evaporation_deposition", 4, 1, 0, 0, new SimpleRecipeBuilder(), false).setSound(GTSoundEvents.ARC);

    public static final RecipeMap<SimpleRecipeBuilder> ORE_SORTER_RECIPES = new RecipeMapOreSorter<>("ore_sorter", 2,
            20, 1, 1, new SimpleRecipeBuilder(), false)
    ...
    public static final RecipeMap<SimpleRecipeBuilder> MINING_DRILL_RECIPES = new RecipeMap<>("mining_drill", 1, 1, 1,
            1, new SimpleRecipeBuilder(), false).setSlotOverlay(false, false, true, GuiTextures.CRUSHED_ORE_OVERLAY)
            .setSlotOverlay(true, false, true, GuiTextures.DUST_OVERLAY).setSound(GTSoundEvents.MACERATOR);
    ...
    public static final RecipeMap<SusyRecipeBuilder> FROTH_FLOTATION = new RecipeMap<>("froth_flotation", 3, 2, 4, 2,
            new SusyRecipeBuilder(), false)
            .setProgressBar(GuiTextures.PROGRESS_BAR_MIXER, ProgressWidget.MoveType.CIRCULAR)
    ...
    public static final RecipeMap<SimpleRecipeBuilder> IN_SITU_LEACHER = new RecipeMap<>("in_situ_leacher", 2, 2, 2, 2,
            new SimpleRecipeBuilder(), false).setSound(GTSoundEvents.COMPRESSOR);

    public static final RecipeMap<SimpleRecipeBuilder> EUV_LITHOGRAPHY = new RecipeMap<>("euv_lithography", 3, 3, 3, 3,
            new SimpleRecipeBuilder(), false).setSound(GTSoundEvents.ELECTROLYZER);
    ...
    public static final RecipeMap<SimpleRecipeBuilder> BLENDER_RECIPES = new RecipeMap<>("blender", 9, 1, 6, 2,
            ...
            .setProgressBar(GuiTextures.PROGRESS_BAR_ARROW_MULTIPLE, ProgressWidget.MoveType.HORIZONTAL)
            .setSound(GTSoundEvents.CHEMICAL_REACTOR).setSmallRecipeMap(MIXER_RECIPES);

    public static final RecipeMap<FuelRecipeBuilder> LARGE_STEAM_TURBINE = new RecipeMap<>("large_steam_turbine", 0, 0,
            1, 1, new FuelRecipeBuilder(), false).setSlotOverlay(false, true, GuiTextures.CENTRIFUGE_OVERLAY)
            .setProgressBar(GuiTextures.PROGRESS_BAR_GAS_COLLECTOR, ProgressWidget.MoveType.HORIZONTAL)
            .setSound(GTSoundEvents.TURBINE).allowEmptyOutput();

    public static final RecipeMap<FuelRecipeBuilder> ADVANCED_STEAM_TURBINE = new RecipeMap<>("advanced_steam_turbine",
            0, 0, 1, 1, new FuelRecipeBuilder(), false).setSlotOverlay(false, true, GuiTextures.CENTRIFUGE_OVERLAY)
            .setProgressBar(GuiTextures.PROGRESS_BAR_GAS_COLLECTOR, ProgressWidget.MoveType.HORIZONTAL)
            .setSound(GTSoundEvents.TURBINE).allowEmptyOutput();
    ...
    public static final RecipeMap<NoEnergyRecipeBuilder> JET_WINGPACK_FUELS = new RecipeMap<>("jet_wingpack_fuels", 0,
            0, 1, 0, new NoEnergyRecipeBuilder(), false).setSlotOverlay(false, false, GuiTextures.DARK_CANISTER_OVERLAY)
            .setProgressBar(GuiTextures.PROGRESS_BAR_GAS_COLLECTOR, ProgressWidget.MoveType.HORIZONTAL)
            .setSound(GTSoundEvents.TURBINE).allowEmptyOutput();
    ...
    public static final RecipeMap<SimpleRecipeBuilder> MILLING_RECIPES = new RecipeMap<>("milling", 2, 1, 0, 0,
            new SimpleRecipeBuilder().EUt(VA[LV]), false).setSound(GTSoundEvents.CUT);

    public static final RecipeMap<MixerSettlerRecipeBuilder> MIXER_SETTLER_RECIPES = new RecipeMap<>("mixer_settler", 2,
            2, 3, 3, new MixerSettlerRecipeBuilder().EUt(VA[LV]), false).setSound(GTSoundEvents.MIXER);

    public static final RecipeMap<SusyRecipeBuilder> QUARRY_RECIPES = new RecipeMap<>("quarry", 1, 9, 0, 0,
            new SusyRecipeBuilder(), false).setSound(GTSoundEvents.MINER);
    ...
    public static final RecipeMap<SimpleRecipeBuilder> ATTRITION_SCRUBBER = new RecipeMap<>("attrition_scrubber", 2, 3,
            1, 1, new SimpleRecipeBuilder().EUt(VA[LV]), false)
            .setSlotOverlay(false, false, GuiTextures.CRUSHED_ORE_OVERLAY)
            .setSlotOverlay(true, false, GuiTextures.DUST_OVERLAY)
    ...
    public static final RecipeMap<FuelRecipeBuilder> BOILER_RECIPES = new RecipeMap<>("boiler", 1, 0, 0, 0,
            ...
            .setProgressBar(GuiTextures.PROGRESS_BAR_ARROW, ProgressWidget.MoveType.HORIZONTAL)
            .setSlotOverlay(false, false, GuiTextures.FURNACE_OVERLAY_1).setSound(GTSoundEvents.BOILER)
            .allowEmptyOutput();
    ...
    public static final RecipeMap<SimpleRecipeBuilder> RESIST_PROCESSOR = new RecipeMap<>("resist_processing", 1, 1, 5,
            0, new SimpleRecipeBuilder(), false).setSound(GTSoundEvents.CENTRIFUGE); // because it spins
    ...
    public static final RecipeMap<SimpleRecipeBuilder> EDM_RECIPES = new RecipeMap<>("edm", 3, 3, 1, 1,
            new SimpleRecipeBuilder(), false).setSound(GTSoundEvents.ELECTROLYZER);

    public static final RecipeMap<SimpleRecipeBuilder> CARGO_DRONE_PAD = new RecipeMap<>("cargo_drone_pad", 1, 1, 0, 0,
            new SimpleRecipeBuilder(), true);
    ...
    static {
        ...
        MIXER_RECIPES.onRecipeBuild(recipeBuilder -> SuSyRecipeMaps.BLENDER_RECIPES.recipeBuilder()
                ...
                .chancedFluidOutputs(recipeBuilder.getChancedFluidOutputs()).cleanroom(recipeBuilder.getCleanroom())
                .duration(recipeBuilder.getDuration()).EUt(recipeBuilder.getEUt()).buildAndRegister());
        ...
        BOILER_RECIPES.onRecipeBuild(recipeBuilder -> {
            ...
            for (OrePrefix prefix : SuSyBoilerLogic.SUPPORTED_ORE_PREFIXES) {
                ...
                if (!otherInput.isEmpty()) {
                    ...
                    if (duration > 0) {
                        BOILER_RECIPES.recipeBuilder().inputs(otherInput).duration(duration).EUt((int) V[LV])
                                .buildAndRegister();
                    }
                }
            }
        ...
        SuSyRecipeMaps.BALL_MILL.onRecipeBuild(recipeBuilder -> recipeBuilder.fluidInputs(
                SusyMaterials.PreheatedAir.getFluid(recipeBuilder.getDuration() * recipeBuilder.getEUt() / 512)));
        ...
        RecipeMaps.ORE_WASHER_RECIPES.onRecipeBuild(recipeBuilder -> {
            RecipeBuilder<SimpleRecipeBuilder> atBuilder = SuSyRecipeMaps.ATTRITION_SCRUBBER.recipeBuilder()
                    ...
                    .chancedOutputs(recipeBuilder.getChancedOutputs()).fluidOutputs(recipeBuilder.getFluidOutputs())
                    .chancedFluidOutputs(recipeBuilder.getChancedFluidOutputs()).cleanroom(recipeBuilder.getCleanroom())
                    .duration(recipeBuilder.getDuration()).EUt(recipeBuilder.getEUt());
