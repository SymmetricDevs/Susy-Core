...
public class RegolithConfig {
    ...
    public static void init() {
        ...
        SuSyBiomes.setCraterBlock(SuSyBiomes.LUNAR_HIGHLANDS,
        ...
        SuSyBiomes.setCraterBlock(SuSyBiomes.LUNAR_MARIA,
                SuSyBlocks.REGOLITH.getState(BlockRegolith.BlockRegolithType.LOWLAND));

        // Lunar KREEP Terrane
        SuSyBiomes.setCraterBlock(SuSyBiomes.LUNAR_KREEP_TERRANE,
