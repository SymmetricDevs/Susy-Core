...
import supersymmetry.api.capability.impl.BiomeMultiRecipeLogic;

import java.util.function.Function;

public class BiomeMultiMachineMetaTileEntity extends SimpleMachineMetaTileEntity {
    ...
    public BiomeMultiMachineMetaTileEntity(ResourceLocation metaTileEntityId, RecipeMap<?> recipeMap, ICubeRenderer renderer, int tier, boolean hasFrontFacing, Function<Integer, Integer> tankScalingFunction) {
        super(metaTileEntityId, recipeMap, renderer, tier, hasFrontFacing, tankScalingFunction);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new BiomeMultiMachineMetaTileEntity(this.metaTileEntityId, this.workable.getRecipeMap(), this.renderer, this.getTier(), this.hasFrontFacing(), this.getTankScalingFunction());
    }

    @Override
    protected BiomeMultiRecipeLogic createWorkable(RecipeMap<?> recipeMap) {
        return new BiomeMultiRecipeLogic(this, recipeMap, () -> this.energyContainer);
    }
