...
public class SuSyLateMixinLoader implements ILateMixinLoader {
    ...
    public static final List<String> modMixins = ImmutableList.of("bdsandm", "gregtech", "mcjtylib_ng", "xnet", "travelersbackpack", "yungs", "reccomplex", "fluidlogged_api","rftools");
